...
export function EmptyResults({ category, location, hasActiveFilters, clearHref }: EmptyResultsProps) {
      ...
      <div className="flex flex-col items-center gap-6 py-20 text-center">
        ...
        <div className="flex flex-col gap-2">
          ...
          <p className="max-w-sm text-sm leading-relaxed text-ink-500">
            Try widening your price range, lowering the rating requirement, or clearing a filter to
            see more providers.
          </p>
        </div>
        <a
  ...
  const hasSearch = category || location;
