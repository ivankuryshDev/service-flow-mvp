...
export const mockProviders: Provider[] = [
  ...
  },
  {
    ...
    reviewsCount: 156,
    location: 'Dublin 7',
    address: '45 North Circular Road, Dublin 7',
    shortDescription: 'Budget-friendly repairs with fast turnaround. Walk-ins welcome.',
  },
  {
    id: 'prv-10',
    name: 'EcoClean Dublin',
    serviceIds: ['svc-4'],
    rating: 4.2,
    reviewsCount: 88,
    location: 'Clontarf',
    address: '12 Clontarf Road, Dublin 3',
    shortDescription: 'Eco-friendly cleaning with non-toxic products. Flexible scheduling.',
  },
  {
    id: 'prv-11',
    name: 'Pembroke Dental',
    serviceIds: ['svc-3'],
    rating: 4.7,
    reviewsCount: 61,
    location: 'Dublin 4',
    address: '15 Pembroke Road, Dublin 4',
    shortDescription: 'Family-friendly dental practice with early-morning appointments.',
  },
];